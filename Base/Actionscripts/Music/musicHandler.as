package  
{
	...
	public class musicHandler extends MovieClip {
		...
		private var soundTrack:Array = new Array(TITLE,LEVEL1, BOSS);
		private var mPos:int = 0;
		private var currentTrack:String = "NULL";

		public function musicHandler(track:String = null) {
			// constructor code
			setMusicAndPlay(track);
		}
		
		public function getMaxTracks(){
			var max:int = 0;
		...
		public function displaySoundTrack(){
		...
		private function completeSound(e:Event){
			//trace("PLaying from " + mPos);
   			playMusic(mPos);
		}
		
		public function setMusicAndPlay(track:String, position:int = 0){
			stopMusic();
			mPos = position;
			switch (track){
				case TITLE:
		...
		public function playMusic(position){
			mPos = position;
			stopMusic();
